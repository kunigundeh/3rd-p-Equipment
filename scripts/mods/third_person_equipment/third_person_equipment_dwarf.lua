...
mod.definitions.dr_1h_axe_shield = {
    right = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
...
mod.definitions.dr_handgun = {
    right = {
        ...
        back = { node = default_node, position = {0.3, -0.2, -0.2}, rotation = {0, 30, 90},												-- Default / V1				2.1.0
            dr_ranger = {
                node = default_node, position = {0.2, -0.2, -0.2}, rotation = {0, 30, 90},												-- V2 ranger				2.1.0
                skin_dr_default = { node = default_node, position = {0.2, -0.2, -0.2}, rotation = {0, 30, 90}, },							-- V2 classic ranger skin	2.1.0
            },
            dr_ironbreaker = { node = default_node, position = {0.2, -0.2, -0.2}, rotation = {180, 180, 0}, },								-- V2 ironbreaker			2.1.0
        },
    },
}
...
mod.definitions.dr_1h_hammer = {
    right = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = { copy = "backpack", },																								-- V2 ranger				2.1.0
            dr_ironbreaker = { copy = "backpack", },																						-- V2 ironbreaker			2.1.0
            dr_slayer = { node = default_node, position = {0.2, -0.2, 0.1}, rotation = {0, -110, 90}, },									-- V2 slayer				2.1.0
        },
        backpack = { node = backpack_node, position = {0.3, -0.5, 0.1}, rotation = {40, 160, 20},											-- Default / V1				2.1.0
            dr_ranger = { 
...
mod.definitions.dr_2h_hammer = {
    right = {
        back = {node = default_node, position = {0.5, -0.22, 0.2}, rotation = {0, -110, 90}, replace = "backpack", 												-- Default / V1				2.1.0
            dr_ranger = { node = default_node, position = {0.5, -0.22, 0.2}, rotation = {0, -110, 90}, replace = "backpack", },																								-- V2 ranger				2.1.0
            dr_ironbreaker = { node = default_node, position = {0.5, -0.22, 0.2}, rotation = {0, -110, 90}, },							-- V2 ironbreaker			2.1.0
            dr_slayer = { node = default_node, position = {0.5, -0.22, 0.2}, rotation = {0, -110, 90}, replace = "backpack", },			-- V2 slayer				2.1.0
        },
        backpack = { node = backpack_node, position = {0.1, -0.8, 0.5}, rotation = {40, 160, 20},											-- Default / V1				2.1.0
            ...
            dr_slayer = { node = default_node, position = {0.5, -0.2, -0.3}, rotation = {0, -60, -90}, replace = "back", },				-- V2 slayer				2.1.0
        },
    },
}
...
mod.definitions.dr_dual_wield_hammers = {
    right = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.2.0
            dr_ranger = { copy = "backpack", },																								-- V2 ranger				2.2.0
            dr_ironbreaker = { copy = "backpack", },																						-- V2 ironbreaker			2.2.0
            dr_slayer = { node = default_node, position = {0.2, -0.2, 0.1}, rotation = {0, -110, 90}, replace = "belt", },                -- V2 slayer    			2.2.0
        },
    ...
    left = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.2.0
            dr_ranger = { copy = "backpack", },																								-- V2 ranger				2.2.0
            dr_ironbreaker = { copy = "backpack", },																						-- V2 ironbreaker			2.2.0
            dr_slayer = { node = default_node, position = {0.2, -0.2, -0.2}, rotation = {12, -50, -78}, replace = "belt", },              -- V2 slayer    			2.2.0
        },
        backpack = { node = backpack_node, position = {0.3, -0.5, 0.1}, rotation = {40, 160, 20},											-- Default / V1				2.2.0
            dr_ranger = { 
...
mod.definitions.dr_1h_axes = {
    right = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = {
                node = default_node, position = {0.2, -0.2, 0.1}, rotation = {0, -110, 90},												-- V2 ranger				2.1.0
                skin_dr_default = { node = default_node, position = {0.35, -0.15, 0.1}, rotation = {0, -110, 90}, },						-- V2 classic ranger skin	2.1.0
            },
            dr_ironbreaker = { node = default_node, position = {0.2, -0.21, 0.1}, rotation = {0, -110, 90}, },							-- V2 ironbreaker			2.1.0
            dr_slayer = { node = default_node, position = {0.2, -0.2, 0.1}, rotation = {0, -110, 90}, },									-- V2 slayer				2.1.0
        },
        backpack = { node = backpack_node, position = {0.3, -0.5, 0.1}, rotation = {40, 160, 20},											-- Default / V1				2.1.0
            dr_ranger = { 
...
mod.definitions.dr_2h_axes = {
    right = {
        back = { node = default_node, position = {0.5, -0.2, 0.2}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = {
                node = default_node, position = {0.5, -0.2, 0.2}, rotation = {0, -110, 90},												-- V2 ranger				2.1.0
                skin_dr_default = { node = default_node, position = {0.5, -0.15, 0.2}, rotation = {0, -110, 90}, },						-- V2 classic ranger skin	2.1.0
            },
            dr_ironbreaker = { node = default_node, position = {0.5, -0.22, 0.2}, rotation = {0, -110, 90}, },							-- V2 ironbreaker			2.1.0
            dr_slayer = { node = default_node, position = {0.5, -0.2, 0.2}, rotation = {0, -110, 90}, replace = "backpack", }				-- V2 slayer				2.1.0
        },
        backpack = { node = backpack_node, position = {0.1, -0.8, 0.5}, rotation = {40, 160, 20},											-- Default / V1				2.1.0
            dr_ranger = {
                attachment = 2, attachment_node = 9, position = {0.3, -0.12, -0.6}, rotation = {0, -40, 90},								-- V2 ranger				2.5.0
...
mod.definitions.dr_2h_picks = {
    right = {
        back = { node = default_node, position = {0.5, -0.17, 0.2}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = {
                node = default_node, position = {0.5, -0.17, 0.2}, rotation = {0, -110, 90},												-- V2 ranger				2.1.0
                skin_dr_default = { node = default_node, position = {0.5, -0.15, 0.2}, rotation = {0, -110, 90}, },						-- V2 classic ranger skin	2.1.0
            },
            dr_ironbreaker = { node = default_node, position = {0.5, -0.22, 0.2}, rotation = {0, -110, 90}, },							-- V2 ironbreaker			2.1.0
            dr_slayer = { node = default_node, position = {0.5, -0.2, 0.2}, rotation = {0, -110, 90}, replace = "backpack", },			-- V2 slayer				2.1.0
        ...
        backpack = { node = backpack_node, position = {0.1, -0.8, 0.5}, rotation = {40, 160, 20},											-- Default / V1				2.1.0
            ...
            dr_ironbreaker = { attachment = 1, attachment_node = 6, position = {-0.15, -0.03, 0.7}, rotation = {0, 180, -60}, },			-- V2 ironbreaker			2.1.0
            dr_slayer = { replace = "back", node = default_node, position = {0.5, -0.2, -0.3}, rotation = {0, -60, -90}, },				-- V2 slayer				2.1.0
        },
    },
}
...
mod.definitions.dr_grudgeraker = {
    right = {
        ...
        back = { node = default_node, position = {0.3, -0.2, -0.2}, rotation = {0, 30, 90},												-- Default / V1				2.1.0
            dr_ranger = {
                node = default_node, position = {0.2, -0.2, -0.2}, rotation = {0, 30, 90},												-- V2 ranger				2.1.0
                skin_dr_default = { node = default_node, position = {0.2, -0.15, -0.2}, rotation = {0, 30, 90}, },						-- V2 classic ranger skin	2.1.0
            },
            dr_ironbreaker = { node = default_node, position = {0.2, -0.2, -0.2}, rotation = {0, 30, 90}, },								-- V2 ironbreaker			2.1.0
        },
    },
}
...
mod.definitions.dr_crossbow = {
    left = {
        ...
        back = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110},												-- Default / V1				2.1.0
            dr_ranger = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110}, },																								-- V2 ranger				2.1.0
            dr_ironbreaker = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110}, },																						-- V2 ironbreaker			2.1.0
        },
    },
}
...
mod.definitions.dr_dual_axes = {
    right = {
        ...
        back = { node = default_node, position = {0.2, -0.2, 0.1}, rotation = {0, -110, 90}, replace = "belt", },		                    -- Default / V1		2.1.0
    ...
    left = {
        ...
        back = { node = default_node, position = {0.2, -0.2, -0.2}, rotation = {12, -50, -78}, replace = "belt", },	                    -- Default / V1		2.1.0
        backpack = { copy = "back", replace = "belt", },																                    -- Default / V1		2.1.0
    },
}

-- ##### Cog Hammer ######################################################################################################
mod.definitions.dr_cog_hammer = {
    right = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = {
                node = default_node, position = {0.2, -0.2, 0.1}, rotation = {0, -110, 90},												-- V2 ranger				2.1.0
...
-- ##### Masterwork pistol ####################################################################################################
mod.definitions.dr_steam_pistol = {
    right = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = { copy = "backpack", },																								-- V2 ranger				2.1.0
            dr_ironbreaker = { copy = "backpack", },																						-- V2 ironbreaker			2.1.0
...
mod.definitions.dr_1h_throwing_axes = {
    left = {
        back = { node = default_node, position = {0.4, -0.2, 0.1}, rotation = {0, -110, 90},												-- Default / V1				2.1.0
            dr_ranger = { copy = "backpack", },																								-- V2 ranger				2.1.0
            dr_ironbreaker = { copy = "backpack", },																						-- V2 ironbreaker			2.1.0
...
mod.definitions.dr_deus_01 = {
    left = {
        backpack = { node = backpack_node, position = {-0.1, -0.3, 0.15}, rotation = {-10, 120, -10},										-- Default / V1				2.1.0
            ...
            dr_ironbreaker = { node = default_node, position = {-0.1, -0.3, 0.15}, rotation = {-10, 120, -10}, },				-- V2 ironbreaker			2.1.0
        },
        back = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110},												-- Default / V1				2.1.0
            dr_ranger = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110}, },																								-- V2 ranger				2.1.0
            dr_ironbreaker = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110}, },	
            dr_engineer = { node = default_node, position = {0.2, -0.2, -0.1}, rotation = {270, 0, 110}, },																					-- V2 ironbreaker			2.1.0
        },
    },
}
