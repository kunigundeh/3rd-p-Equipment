-- config file for Bardin Ironbreaker's Vallaya's Hearthguard Skin

local tisch = {["units/beings/player/dwarf_ranger_irondrake/third_person_base/chr_third_person_mesh"] = {
    dr_drakegun = {
      right = {
        offset = {
          0.093999996781349,
